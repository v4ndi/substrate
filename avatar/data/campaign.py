...
This used to be an entrypoint of its own (``avatar/cam_inference.py``), which
differed from :mod:`avatar.inference` by exactly this loop. It is not an
entrypoint but an argument: :func:`avatar.train.evaluate.predict` already takes

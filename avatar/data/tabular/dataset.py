...
from avatar.data.base.iterable import BaseShardedParquetDataset
from avatar.data.base.parquet import parquet_num_rows, read_parquet_file
from avatar.data.sampler import BaseSampler, MultiTaskColumnsFilterSampler
...
class TabularDataset(BaseShardedParquetDataset):
    ...
    :class:`~avatar.data.tabular.collate.TabularCollateFn` stacks into a
    :class:`~avatar.data.tabular.batch.TabularBatch`.
    ...
    Args:
        ...
        sampler: Record-stream sampler. A
            :class:`~avatar.data.sampler.MultiTaskColumnsFilterSampler` is
    ...
    :class:`~avatar.data.base.iterable.BaseShardedParquetDataset`.
    """

...
:class:`avatar.preprocessing.spark.LabelEncoder`, so an artifact fitted by either
...
from avatar.preprocessing.base.accumulators import ValueCountAccumulator
from avatar.preprocessing.base.encode import CategoricalMapper

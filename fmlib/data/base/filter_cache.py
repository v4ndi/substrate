...
from fmlib.data.base.fs import file_stat, is_local_filesystem
from fmlib.data.base.parquet import parquet_num_rows, read_parquet_columns
...
class SourceFilter(Protocol):
    ...
    Implemented by
    :class:`fmlib.data.sampler.MultiTaskColumnsFilterSampler`.
    """
...
class PersistentFilterCache:
    ...
    def _initialize_paths(self, payload: dict) -> str:
        ...
        if self.cache_dir is None:
            ...
            cache_root = os.path.join(common_path, ".fmlib_filter_cache")
        else:

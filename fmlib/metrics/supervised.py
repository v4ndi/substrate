...
from fmlib.metrics.base import ArtifactMetric
from fmlib.metrics.grouped import (
    CALIB_SPLIT,
    TEST_SPLIT,
...
class SupervisedMetric(GroupedPredictionMetric):
    ...
    submit file — comes from :class:`~fmlib.metrics.grouped.GroupedPredictionMetric`.
    """

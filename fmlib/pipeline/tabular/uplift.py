...
:class:`~fmlib.pipeline.tabular.supervised.SupervisedLearner` and adds exactly
...
from fmlib.outputs import MultiGroupUpliftOutput
from fmlib.pipeline.tabular.interaction import (
    BaseTreatmentInteraction,
    ConcatTreatmentInteraction,
)
from fmlib.pipeline.tabular.supervised import SupervisedLearner
...
class SLearner(SupervisedLearner):
    ...
    Beyond :class:`~fmlib.pipeline.tabular.supervised.SupervisedLearner`:
    ...
    Returns:
        :class:`~fmlib.outputs.MultiGroupUpliftOutput`. During training
